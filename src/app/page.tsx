...
// Importer CSS-modulen i stedet for Tailwind
...
export default function Home() {
  ...
  const handleSignUpWithEmail = async (e: React.FormEvent) => {
    ...
    // Sørg for at display name er fylt ut
    if (!displayName.trim()) {
    ...
    try {
      ...
      // Oppdater brukerprofilen med display name
  ...
  return (
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        {/* Skjema for registrering med display name, e-post og passord */}
